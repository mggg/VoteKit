...
#         ValueError,
#         match=re.escape(
#             f"Candidate Chris was provided in candidates ['Chris', 'Peter'] but "
...
#         ValueError,
#         match=re.escape(
#             f"Candidate Chris was found in the csv but not provided in candidates ['Peter']."
#         ),
#     ):
