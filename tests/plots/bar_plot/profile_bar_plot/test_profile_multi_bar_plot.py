from votekit.plots.profiles import profile_multi_bar_plot
...
def test_barplot_with_defaults():
    ...
    ax = profile_multi_bar_plot(
        {"Profile 1": profile_1, "Profile 2": profile_2}, stat_function="ballot length"
    )
    assert isinstance(ax, Axes)
