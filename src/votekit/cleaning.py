...
profile = PreferenceProfile(
        ballots=[
            Ballot(ranking=[{'A'}, {'A'}, {'B'}], weight=10),
            Ballot(ranking=[{'A'}, {'A'}, {'B'}], weight=10),
            Ballot(ranking=[{'A'}, {'B'}, {'A'}], weight=5),
            Ballot(ranking=[{'A'}, {'A'}, {'B'}], weight=7),
            Ballot(ranking=[{'A'}, {'B'}, {'C'}], weight=5)
        ]
)

overvoted_pp = overvote(profile)
print(overvoted_pp)
print(clean(overvoted_pp))
